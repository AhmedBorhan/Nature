...
function Navbar() {
    ...
    return (
        <div className={code === 'en'?"navigation":"navigation right_to_left"}>
            <input type="checkbox" checked={state} onChange={onCheck} className="navigation__checkbox" id="navi-toggle" />

            <label htmlFor="navi-toggle" className={code === 'en'?"navigation__button_en navigation__button":"navigation__button"}>
                <span className="navigation__icon">&nbsp;</span>
            </label>

            <div className={code === 'en'?"navigation__background_en navigation__background":"navigation__background"}>&nbsp;</div>
            ...
            <nav className="navigation__nav">
                <ul className="navigation__list">
                    ...
                    <li className="navigation__item btn__holder">
                        <button className="btn btn--white"  onClick={() => { setLan('en') }} >English</button>
                        <button className="btn btn--white"  onClick={() => { setLan('ar') }} >عربي</button>
                        <button className="btn btn--white"  onClick={() => { setLan('kr') }} >کوردی</button>
                    </li>
                </ul>
            </nav>
        </div>
